...
const ffmpegmod = require('ffmpeg-static-electron');
...
module.exports = function (spec) {
  ...
  function concatClips(args) {
    ...
    return new Promise((resolve, reject) => {
      let ffmpeg = `${ffmpegmod.path} -f concat -safe 0 -protocol_whitelist file,http,https,tcp,tls,crypto -i ${args.fileList} -c copy ${outputFileName} ${overwrite}`;
